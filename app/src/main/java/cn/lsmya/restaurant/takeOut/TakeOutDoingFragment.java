...
public class TakeOutDoingFragment extends BaseFragment implements BaseRecyclerViewAdapter.OnChildViewClickListener, ApiClientResponseWithPullHandler.GetPullLayout {
    ...
    private static class ApiHandler extends ApiClientResponseWithPullHandler<TakeOutDoingFragment> {
