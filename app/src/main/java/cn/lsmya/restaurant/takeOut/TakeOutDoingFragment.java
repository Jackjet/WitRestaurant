...
public class TakeOutDoingFragment extends BaseFragment implements BaseRecyclerViewAdapter.OnChildViewClickListener {
    ...
    private static class ApiHandler extends ApiClientResponseHandler<TakeOutDoingFragment> {
        public ApiHandler(TakeOutDoingFragment the) {
            super(the);
        }

        @Override
        public void onSuccess(TakeOutDoingFragment the, ApiClientRequest request, ApiClientResponse response) {
        ...
        @Override
        public void onFinished(TakeOutDoingFragment the, ApiClientRequest request) {
        ...
        @Override
        public boolean onSubmitBefore(TakeOutDoingFragment the, ApiClientRequest request) {
            if (request.isRoute(ROUTE.ORDER_LIST)) {
