...
public class TakeOutToDoFragment extends BaseFragment implements BaseRecyclerViewAdapter.OnChildViewClickListener {
    ...
    private static class ApiHandler extends ApiClientResponseHandler<TakeOutToDoFragment> {
        public ApiHandler(TakeOutToDoFragment the) {
            super(the);
        }

        @Override
        public void onSuccess(TakeOutToDoFragment the, ApiClientRequest request, ApiClientResponse response) {
        ...
        @Override
        public void onFinished(TakeOutToDoFragment the, ApiClientRequest request) {
