...
public class PullRecyclerViewAdapter extends RecyclerView.Adapter {
    ...
    public void setRecyclerViewFooter(PullRecyclerViewFooter recyclerViewFooter) {
        this.recyclerViewFooter = recyclerViewFooter;
    }

    public void setRecyclerViewHeader(PullRecyclerViewHeader recyclerViewHeader) {
    ...
    public PullRecyclerViewAdapter(Context context, RecyclerView.Adapter adapter) {
        mContext = context;
