...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    private ViewClickListener.OnChildViewClickListener onChildViewClickListener;
    ...
    public RecyclerViewAdapter(List list, int resource, OnBindView bindView, ViewClickListener.OnChildViewClickListener childViewClickListener) {
        this.mList = list;
        this.mResource = resource;
        this.mBindView = bindView;
