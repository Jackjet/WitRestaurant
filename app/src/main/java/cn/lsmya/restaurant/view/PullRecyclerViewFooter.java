...
public class PullRecyclerViewFooter extends LinearLayout {
    ...
    public PullRecyclerViewFooter(Context context) {
        super(context);
        initView(context);
    }

    public PullRecyclerViewFooter(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }
