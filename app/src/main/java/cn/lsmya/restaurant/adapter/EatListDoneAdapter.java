...
public class EatListDoneAdapter extends BaseRecyclerViewAdapter<EatListDoneAdapter.ViewHolder> {
    public EatListDoneAdapter(Context context, List list, OnChildViewClickListener onChildViewClickListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_eat_done, parent, false));
    }

    class ViewHolder extends RecyclerView.ViewHolder {
        @BindView(R.id.itemEatDone_name)
        TextView name;
        @BindView(R.id.itemEatDone_address)
        TextView address;
        @BindView(R.id.itemEatDone_money)
        TextView money;
        @BindView(R.id.itemEatDone_time)
        TextView time;
        @BindView(R.id.itemEatDone_data)
        TextView data;
