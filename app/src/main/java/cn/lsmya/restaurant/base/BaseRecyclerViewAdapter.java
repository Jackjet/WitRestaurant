...
public class BaseRecyclerViewAdapter<T extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<T> {
    ...
    public BaseRecyclerViewAdapter(Context context, ArrayList list) {
        this.context = context;
        this.list = list;
    }

    public BaseRecyclerViewAdapter(Context context, ArrayList list, OnChildViewClickListener onChildViewClickListener) {
        this.context = context;
        this.list = list;
